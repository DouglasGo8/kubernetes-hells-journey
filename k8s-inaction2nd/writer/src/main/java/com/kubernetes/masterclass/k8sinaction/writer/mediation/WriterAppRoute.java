package com.kubernetes.masterclass.k8sinaction.writer.mediation;

import com.kubernetes.masterclass.k8sinaction.writer.model.Quotes;
...
public class WriterAppRoute extends RouteBuilder {
  ...
  public void configure() {
    ...
    from("timer://writerApp?fixedRate=true&period=2s")
            ...
            .end() // end aggregate
            .delay(simple("${random(4000,10000)}"))
            .log(LoggingLevel.INFO, "Trigger file creation!!!")
            .end();
  }
}
